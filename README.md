...
**[프로젝트 기간]** 2023/11/20 ~ 2023/11/30 </br>
...
주어진 달의 총 수입을 계산하여 보여준다. 모든 달은 30일로 가정한다. </br>
* 거주자 우선주차 요금 </br>
   - 월별 요금을 계산한다. 중간에 배정을 받으면 배정일을 포함하여 말일이나 철회한 날까지의 날 수를 계산하여 요금을 비율대로 계산한다. </br>
   - 가령, 9월 5일에 배정을 받고, 9월 20일에 배정 철회를 하면, 20-5+1 = 16일치의 요금이 계산된다. 9월 주차요금 = 50000원 * 16/30 </br>
* 일반 차량 주차요금 </br>
   - 10분 단위로 계산한다. 10분 미만이면 10분으로 처리한다. </br>
   - 주차요금 = 주차시간/ 10분 * 10분당 주차요금 </br>
</br>
